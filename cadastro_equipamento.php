...
<head>
  ...
  <link href="css/form_equipamento.css" rel="stylesheet">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand 
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Sistema de Reservas de Equipamentos Multimídia</div>
            </a>  -->
      ...
      <li class="nav-item active">
        <a class="nav-link" href="painel_adm.php">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="asset/reserva-256.png">
              </a>
        ...
        <div class="mb-3">
          ...
          <form class="form-equipamento" method="POST" action="insert_equipamento.php">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Ssistema de Reservas de Equipamentos Multimídias 2022</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
